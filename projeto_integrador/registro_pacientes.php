<?php
    if(isset($_POST['submit'])) {
        ...
        $result = mysqli_query($conexao1, "INSERT INTO usuarios(nome, email, telefone, sexo, data_nasc, cidade, estado, endereco)
...
<body>
	<header>
	  <a href="index.php">
	  	<img src="img/Logo_Principal.jpeg" alt="Banner com logo da clinica anakai. borboleta com outras borboletas e fundadora, Êmili Cassimiro">
	  </a>
	</header>
	<div class="box">
		<form action="registro_pacientes.php" method="POST">
			<fieldset>
